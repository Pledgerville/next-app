      ...
      <Card maxW='md'>
        <CardBody p={2}>
          ...
          <Stack mt='6' spacing='3'>
            <Heading fontFamily='Linotype Didot' fontSize='xl' size='md'>
              {title}
            </Heading>
